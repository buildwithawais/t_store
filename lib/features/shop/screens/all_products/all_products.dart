...
class AllProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      /// -- AppBar
      appBar: TCustomAppBar(title: Text(title, style: Theme.of(context).textTheme.displayMedium,), showBackArrow: true),
        ...
        child: Padding(
          ...
          child: FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              // Return appropriate widget based on snapshot response
